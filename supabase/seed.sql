...
-- =============================================
-- エアラブ (airluv.) 全モデル
-- カテゴリ: ベビーカー > 周辺グッズ  ブランド: Poled
-- =============================================

INSERT INTO products (id, name, category, sub_category, brand, image_url, description, rating, reviews_count)
VALUES
(
...
INSERT INTO shops_prices (product_id, shop_name, shop_type, lowest_price, benefits, sellers) VALUES
('22222222-2222-2222-2222-000000000001', 'Amazon', 'mall', 7980, NULL,
...
('22222222-2222-2222-2222-000000000001', '楽天市場', 'mall', 8250, NULL,
...
('22222222-2222-2222-2222-000000000002', 'Poled Japan 公式', 'official', 9900, ARRAY['公式保証付き', '送料無料'],
 '[{"name": "Poled Japan 公式ストア", "price": 9900, "shipping": 0, "points": 99, "url": "https://shop.poled.co.jp/en"}]'::jsonb),
('22222222-2222-2222-2222-000000000002', 'Amazon', 'mall', 9680, NULL,
...
('22222222-2222-2222-2222-000000000002', '楽天市場', 'mall', 9900, NULL,
...
('22222222-2222-2222-2222-000000000003', 'Poled Japan 公式', 'official', 11900, ARRAY['公式保証付き', '送料無料'],
 '[{"name": "Poled Japan 公式ストア", "price": 11900, "shipping": 0, "points": 119, "url": "https://shop.poled.co.jp/en"}]'::jsonb),
('22222222-2222-2222-2222-000000000003', 'Amazon', 'mall', 11500, NULL,
...
('22222222-2222-2222-2222-000000000003', '楽天市場', 'mall', 11800, NULL,
...
('22222222-2222-2222-2222-000000000004', 'Poled Japan 公式', 'official', 11900, ARRAY['公式保証付き', '送料無料', 'USB Type-C対応'],
 '[{"name": "Poled Japan 公式ストア", "price": 11900, "shipping": 0, "points": 119, "url": "https://shop.poled.co.jp/en"}]'::jsonb),
('22222222-2222-2222-2222-000000000004', 'Amazon', 'mall', 11480, NULL,
...
('22222222-2222-2222-2222-000000000004', '楽天市場', 'mall', 11980, NULL,
 '[{"name": "楽天市場", "price": 11980, "shipping": 0, "points": 599, "url": "https://item.rakuten.co.jp/justrich/10000977/"}]'::jsonb),
('22222222-2222-2222-2222-000000000004', 'ベビーザらス', 'specialty', 12000, ARRAY['店舗受け取り可'],
